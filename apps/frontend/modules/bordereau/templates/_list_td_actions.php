...
<?php echo link_to(__('Réception Paiement', array(), 'messages'), 'bordereau/ListPayed?id='.$tbl_bordereau->getId(), array(  'confirm' => 'Etes vous sûr que le bordereau est réglé ?',)) ?>
<?php endif; ?>
